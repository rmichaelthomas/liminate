```json
{
  ...
  "program": "perceptron",
  "rule_summary": "calculates prediction",
  ...
  "fidelity_events": [
    {
      "kind": "none",
      "cobol": "COMPUTE PREDICTION = PREDICTION + W2 * FEAT2",
...
Source excerpt line: `COMPUTE PREDICTION = PREDICTION + W2 * FEAT2`
Duplicate count collapsed into this rule: 0.
Pack-needed rationale: calculates prediction
